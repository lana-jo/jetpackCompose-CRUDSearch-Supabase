                    ...
                    Column(
                        ...
                        Button(
                            ...
                            onClick = {
                                ...
                                val productPrice = if (price.value.isEmpty()) 0.0 else price.value.trim().toDouble()
                                Log.d("tombol add on AddProductScreen", "Adding product with name: $productName, price: $productPrice")
